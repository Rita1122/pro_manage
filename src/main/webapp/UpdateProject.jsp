...
<div class="mainBox">
    ...
    <form method="post" action="/UpdateProject">
        <table cellpadding="10px" align="center">
            <tr>
                <td class="td_left">组长id：<%=id%></td>
            </tr>
            <tr>
                <td class="td_left">项目名称：</td>
                <td class="td_mid"><input type="text" name="title" id="title" value="<%=project.getP_title()%>"></td>
            </tr>
            <tr>
                <td class="td_left">项目描述：</td>
                <td class="td_mid"><input type="text" name="desc" id="desc" value="<%=project.getDesct()%>"></td>
            </tr>
            <tr>
                <td class="td_left">开始时间：</td>
                <td class="td_mid"><input type="datetime-local" name="s_t" id="s_t" value="<%=project.getS_t()%>"></td>
            </tr>
            <tr>
                <td class="td_left">结束时间：</td>
                <td class="td_mid"><input type="datetime-local" name="e_t" id="e_t" value="<%=project.getE_t()%>"></td>
            </tr>
            <tr>
