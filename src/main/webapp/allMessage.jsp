...
<div class="mainBox">
    ...
    <div class="maincontent">
        <a style="margin-left: 600px" href="message" style="text-decoration:none;margin-left: 780px;">
        ...
        <div class="message">
            <table>
                ...
                %>
                <tr><td>发布时间：<%=m.getM_time()%></td></tr>
                <tr><td>发件人：<%=m.getIn_name()%></td></tr>
                <tr><td>收件人：<%=m.getBein_name()%></td></tr>
                <tr><td>内容：<%=m.getM_info()%></td></tr>
