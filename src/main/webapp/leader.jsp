...
<div class="mainBox">
    ...
    <div class="maintable">
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                <th style="padding-left: 80px;padding-right: 120px;">成员编号</th>
                <th style="padding-right: 120px;">成员名称</th>
            ...
            <tr>
                ...
                <td><%=u.getName()%></td>
                <td><a style="text-decoration: none" href="delU?del_id=<%=u.getUser_id()%>">删除</a></td>
            </tr>
            <%
                }
            %>
