...
<div class="mainBox">
    ...
    <form method="post" action="/newPro">
        <table cellpadding="10px" align="center">
            ...
            <tr>
                ...
                <td class="td_mid"><input type="text" name="title" id="title" placeholder="请输入项目名称" required></td>
            </tr>
            <tr>
                <td class="td_left">项目描述：</td>
                <td class="td_mid"><textarea name="desc" id="desc" placeholder="请输入项目描述"></textarea></td>
            </tr>
            <tr>
