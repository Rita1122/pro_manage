...
<div class="leftbox">
    ...
    <div class="leftbox1">
        <a href="extend?id=${sessionScope.curUser.user_id}">
...
<div class="mainBox">
    ...
    <div class="maintable">
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                <th style="padding-left: 80px;padding-right: 200px;">成员编号</th>
            ...
            %>
            <tr>
                <td style="padding-left: 80px;"><%=u.getUser_id()%></td>
                <td><%=u.getName()%></td>
                <td><a style="text-decoration: none" href="invite?leader_id=${sessionScope.curUser.user_id}&&user_id=<%=u.getUser_id()%>"><%=u.getI_status()%></a></td>
            </tr>
            <%
                }
            %>
