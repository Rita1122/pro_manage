...
<div class="mainBox">
    ...
    <div class="maintable">
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                <th style="padding-left: 40px;padding-right: 80px;">项目名称</th>
                <th style="padding-right: 100px;">项目描述</th>
                <th style="padding-right: 70px;">项目任务</th>
                <th style="padding-right: 70px;">删除</th>
            ...
            %>
            <tr>
                <td style="padding-left: 40px;"><%=p.getP_title()%></td>
                <td><%=p.getDesct()%></td>
                <td style="padding-top: 10px"><form action="/Project">
                    <input type="text" name="p_id" value="<%=p.getP_id()%>" hidden>
                    <input type="submit" value="查看任务"></form></td>
                <td style="padding-top: 10px"><form action="/DeleteProject">
                    <input type="text" name="p_id" value="<%=p.getP_id()%>"hidden>
                    <input type="submit" value="删除"></form></td>
                <td style="padding-top: 10px"><form action="/getProject">
                    <input type="text" name="p_id" value="<%=p.getP_id()%>" hidden>
...
<%--            <tr>--%>
<%--                <td style="padding-left: 40px;">${pro.p_title}</td>--%>
<%--                <td>${pro.desct}</td>--%>
<%--                <td style="padding-top: 10px"><form action="/Project">--%>
<%--                    <input type="text" name="p_id" value="${pro.p_id}" hidden>--%>
<%--                    <input type="submit" value="查看任务"></form></td>--%>
<%--                <td style="padding-top: 10px"><form action="/DeleteProject">--%>
<%--                    <input type="text" name="p_id" value="${pro.p_id}" hidden>--%>
<%--                    <input type="submit" value="删除"></form></td>--%>
